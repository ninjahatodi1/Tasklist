...
body.addEventListener('mousemove', bodyBackground);
body.addEventListener('click', setBackground);
}


function bodyBackground(e)
{
    // const random =Math.random()*25;   
  
  // body.style.backgroundColor= ` rgba( ${e.offsetX}, ${e.offsetY}, ${random},0.4 )`;

    // body.style.backgroundColor= " rgba(124,252,0,0.5)";
...
//     // body.style.backgroundColor= ` rgba( ${e.offsetX}, ${e.offsetY}, ${random},0.6 )`;
